                      ...
                      <div class="col-12 col-lg-10 col-xl-8">
                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                                  ...
                                  <!-- Input -->
                                  <input type="number" class="form-control mb-3" placeholder="0.00" v-model="detalle.precio_unidad">
                              ...
                              <div class="form-group">
                                  ...
                                  <!-- Input -->
                                  <input type="text" class="form-control mb-3" placeholder="0" v-model="detalle.cantidad">
