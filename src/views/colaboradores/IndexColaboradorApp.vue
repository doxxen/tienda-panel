                                    ...
                                    >
                                      <tr v-if="!load_data" v-for="item in paginated('colaboradores')">
                                        ...
                                        <td class="text-end">
                                          ...
                                          <b-modal centered :id="'delete-'+item._id" title="BootstrapVue" title-html="<h4 class='card-header-title'><b>Desactivar usuario?</b></h4>" @ok="eliminar(item._id,item.estado)">
